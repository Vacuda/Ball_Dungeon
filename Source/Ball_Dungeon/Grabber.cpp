...
void UGrabber::BeginPlay()
{
	...
	UE_LOG(LogTemp, Error, TEXT("WHY  HELLO!!!!!"));
...
void UGrabber::SetInputComponentAndBindings()
{
	...
	if(InputComponent){
		UE_LOG(LogTemp, Warning, TEXT("inputputututut"))
		InputComponent->BindAction("GrabRelease", IE_Pressed, this, &UGrabber::Grab);
		InputComponent->BindAction("GrabRelease", IE_Released, this, &UGrabber::Release);
	}
}
